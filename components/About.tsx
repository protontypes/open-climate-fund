export default function About() {
  return (
    <section id="about" className="py-16 sm:py-24 bg-black-600">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12 text-green-500">
          About OpenClimate.fund
        </h2>
        <p className="text-base sm:text-lg text-center max-w-3xl mx-auto leading-relaxed text-silver-400">
